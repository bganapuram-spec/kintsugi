...
export const alt = "Kintsugi — Heal in Gold app preview";
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const appName = "Kintsugi — Heal in Gold";
const description = "Kintsugi — Heal in Gold is a mental wellness companion built on the Japanese art of repairing broken pottery with gold lacquer — treating emotional p...";
const icon = "💡";
